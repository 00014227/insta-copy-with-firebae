              ...
              <div className=" border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                {loading ? (
                  ...
                  <div className='flex flex-row'>
                    {isLargeScreen ? (
                      showModal2 && <PublicationForm place={inputs.place} onPlaceChange={onPlaceChange} description={inputs.description} onDescriptionChange={onDescriptionChange} onSubmit={submit} />
                    ) : bodyVisibility ? (
