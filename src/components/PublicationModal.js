                    ...
                    <div className="flex flex-row">
                      ...
                      <div className='w-full'>
                        ...
                        <div className="flex gap-2 mt-4">
                          <button onClick={() => handleLike(currentUserPublication.id, updateState, currentUserPublications)}>
                            {(currentUserPublication.likedBy || []).includes(auth.currentUser.uid) ? (
                              <svg
                        ...
                        <div className="flex">
                <span>{currentUserPublication.likes}</span>
